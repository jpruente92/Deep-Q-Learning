...
class Agent_py_torch():
    ...
    def __init__(self, state_shape, number_actions,hidden_layers,filename_local,filename_target, seed):
        ...
        self.qnetwork_local = QNetwork_pytorch(state_dimension, number_actions,hidden_layers, seed,LR,LOAD,filename_local,self.device).to(self.device)
        self.qnetwork_target = QNetwork_pytorch(state_dimension, number_actions,hidden_layers, seed,LR,LOAD,filename_target,self.device).to(self.device)
